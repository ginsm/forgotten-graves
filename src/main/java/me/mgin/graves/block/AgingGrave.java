...
public interface AgingGrave extends Ageable<AgingGrave.BlockAge> {
	...
	Supplier<ImmutableBiMap<Object, Object>> BLOCK_AGE_INCREASES = Suppliers.memoize(() -> {
        return ImmutableBiMap.builder().put(Graves.GRAVE, Graves.GRAVE_OLD).put(Graves.GRAVE_OLD, Graves.GRAVE_WEATHERED).put(Graves.GRAVE_WEATHERED, Graves.GRAVE_FORGOTTEN).build();
    });
