...
public class ExperienceCalculator {
  ...
  private static int calculateLevelExperience(int level) {
    ...
    if (level <= 16) levelExperience = (int) (levelSquared + 6 * level);
    if (level >= 17 && level <= 31) levelExperience = (int) (2.5 * levelSquared - 40.5 * level + 360);
    if  (level > 31)  levelExperience = (int) (4.5 * levelSquared - 162.5 * level + 2220);
  ...
  private static int calculateProgressExperience(int level, float progress) {
    ...
    if (level <= 15) progressExperience = (int) ((2 * level + 7) * progress);
    if (level >= 16 && level <= 30) progressExperience = (int) ((5 * level - 38) * progress);
    if (level > 30) progressExperience = (int) ((9 * level - 158) * progress);
